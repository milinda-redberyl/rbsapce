        ...
        if (empty($EIdNo)) {
            ...
            if (!empty($employee)) {
                ...
                if ($isSystemAdmin) {
                    ...
                    if ($user_type == "isCompany") {

                        $data2['company_name'] = $Ename1;
                        $result_compny = $this->db->insert('company_master', $data2);

                        if ($result_compny) {
                            $cn = $data2['company_name'];
                            $company = $this->get_company_id($cn);
                            $dataI['company_id'] = $company->company_id;
                        }
                        $dataI['isCompany'] = 1;
                        $dataI['isAgent'] = 0;
                    } else {
                        $dataI['company_id'] = trim($this->input->post('company_sel'));
                        $dataI['isAgent'] = 1;
                    }
                } else {
                    $dataI['isAgent'] = 1;
            ...
            if (!empty($employee)) {
                ...
                if($this->input->post('company_sel') != ""){
                    $data['company_id'] = trim($this->input->post('company_sel'));
                }
