...

{
    ...
    { //property_type_name
        ...
        $this->db->select('ct.category_name AS category_nameas, cm.company_name as company_name,

                    pt.property_type_name AS property_type_name, "property.jpg"  AS imageLink, 

                    a.Ename1 as agentName, a.EpTelephone as telephone, a.EmpImage as imageLink2,
