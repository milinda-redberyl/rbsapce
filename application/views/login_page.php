    ...
    <div class="main-content">
            ...
            <div class="col-sm-10 col-sm-offset-1">
                <div class="login-container">
                    <div class="center">
                        ...
                        <h4 class="blue" id="id-company-text">&copy; <?php echo sys_name() ?></h4>
                    </div>
                            ...
                            <div class="widget-body">
                                <div class="widget-main">
                                    <h4 class="header blue lighter bigger">
                                        ...
                                        <i class="ace-icon fa fa-shield green"></i> Please Enter Your Information
                                    </h4>
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="center">
                <a href="<?php echo base_url() ?>"> <i class="fa fa-chevron-circle-left"></i> Back to Home</a>
                </div>
            </div>
        </div>
    </div><!-- /.main-content -->
